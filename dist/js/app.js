(() => {
    ...
    window.addEventListener("scroll", (function() {
        if (window.scrollY > 0) goTop.style.display = "block"; else goTop.style.display = "none";
    }));
    let script_anchors = document.querySelectorAll('a[href="#header"]');
    ...
    (function() {
        ...
        class VanillaTilt {
            ...
            update() {
                ...
                this.element.style.transform = "perspective(" + this.settings.perspective + "px) " + "rotateX(" + ("x" === this.settings.axis ? 0 : values.tiltY) + "deg) " + "rotateY(" + ("y" === this.settings.axis ? 0 : values.tiltX) + "deg) " + "scale3d(" + this.settings.scale + ", " + this.settings.scale + ", " + this.settings.scale + ")";
                if (this.glare) {
            ...
            updateGlareSize() {
                if (this.glare) Object.assign(this.glareElement.style, {
            ...
            extendSettings(settings) {
                ...
                let newSettings = {};
                for (var property in defaultSettings) if (property in settings) newSettings[property] = settings[property]; else if (this.element.hasAttribute("data-tilt-" + property)) {
